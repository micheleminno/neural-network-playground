...
(function () {
  ...
  function cameFromSara() {
    ...
    try {
      ...
      if (qs.has("sara") || qs.get("embed") === "sara") {
  ...
  var SARA = {
    ...
    nav: [
      ...
      {
        label: "AI & Simulation",
        href: "https://www.sara-systems.net/artificial-intelligence",
      },
      {
        label: "Consulting & Education",
        href: "https://www.sara-systems.net/education",
      },
      {
        label: "Open Source Software",
        href: "https://www.sara-systems.net/open",
      },
  ...
  function build() {
    ...
    var footer = el(
      '<footer class="sara-frame-footer">' +
        ...
        MODULE.name +
        " \u2014 an Interactive Learning Labs module by " +
        MODULE.author +
        ". " +
        "\u00A9 " +
        new Date().getFullYear() +
        " SARA \u2014 The Science Company." +
        "</div>" +
        "</footer>",
    );
